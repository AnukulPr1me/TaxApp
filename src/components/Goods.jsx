...
import taxData from "../assets/taxData";
const Goods = () => {
  return (
    <>
        ...
        <table className="w-full border border-gray-200 ">
          <thead className="border border-gray-500">
            <tr className="bg-blue-200">
              ...
              <th className="p-3 text-left">Compensation Cess</th>
            </tr>
          </thead>
          <tbody>
